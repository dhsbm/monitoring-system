...
<template>
  <ModalWrapper v-model="isShow">
    <div class="bg-white rounded-xl p-5 flex flex-col w-96">
      ...
      <input v-model="title" type="text" placeholder="输入网站名" class="mt-4 p-2 border border-solid border-slate-600 rounded-lg">
      <input v-model="url" type="text" placeholder="输入网站url" class="mt-4 p-2 border border-solid border-slate-600 rounded-lg">
